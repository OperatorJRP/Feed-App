...
import { useRegisterFormStore } from "../../state/registerFormStore"
...
const RegisterForm = ({ isModal = false, onSuccess }: AuthFormProps) => {
  const { signUp, isLoading } = useAuthStore()
  const { closeModals, openSignInModal } = useDialogStore()
  const {
    email,
    password,
    repeatPassword,
